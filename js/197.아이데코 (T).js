...
document.getElementsByClassName('main_banner2')[0].addEventListener('mouseenter',function(){
    clearInterval(auto_interval)
})
document.getElementsByClassName('main_banner2')[0].addEventListener('mouseleave',function(){
    auto_slide()
})
